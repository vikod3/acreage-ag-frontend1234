...
export default function StatsSection() {
  return (
    <section className="bg-black text-white pt-24 pb-8 md:pt-32 md:pb-12 px-6 md:px-12 lg:px-[120px] w-full border-t border-white/10 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-[160px] items-stretch">
          ...
          >
            <h2 className="text-[clamp(1.5rem,4vw,3.5rem)] font-medium tracking-tight mb-6 leading-[1.1] w-[590px] max-w-full">
              <Typewriter text="Powering Harvests" delay={0.1} speed={0.03} /><br />
              <Typewriter text="that " delay={0.6} speed={0.03} /><span className="font-dm-serif italic font-normal"><Typewriter text="Maximize Your Yield" delay={0.8} speed={0.03} /></span>
            </h2>
            <p className="text-base md:text-lg text-white/40 leading-relaxed font-light max-w-lg whitespace-normal mb-16">
              <Typewriter text="For over a decade, the region's most demanding agricultural operations have relied on our modern machinery and skilled crews to secure their crops efficiently and reduce loss." delay={1.2} />
            </p>
            ...
            >
              {/* Stat 1 */}
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut" } } }} className="flex flex-col">
                ...
                <div className="text-[10px] md:text-xs font-semibold text-white/40 uppercase tracking-wider">
                  <Typewriter text="Acres Harvested Annually" delay={0.6} />
                </div>
              </motion.div>
              ...
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut" } } }} className="flex flex-col">
                ...
                <div className="text-[10px] md:text-xs font-semibold text-white/40 uppercase tracking-wider">
                  <Typewriter text="Crop Recovery Rate" delay={0.7} />
                </div>
              </motion.div>
              ...
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut" } } }} className="flex flex-col">
                ...
                <div className="text-[10px] md:text-xs font-semibold text-white/40 uppercase tracking-wider">
                  <Typewriter text="Modern Combines Deployed" delay={0.8} />
                </div>
              </motion.div>
              ...
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut" } } }} className="flex flex-col">
                ...
                <div className="text-[10px] md:text-xs font-semibold text-white/40 uppercase tracking-wider">
                  <Typewriter text="Crop Varieties Supported" delay={0.9} />
                </div>
              </motion.div>
              ...
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut" } } }} className="flex flex-col">
                ...
                <div className="text-[10px] md:text-xs font-semibold text-white/40 uppercase tracking-wider">
                  <Typewriter text="Uptime During Season" delay={1.0} />
                </div>
              </motion.div>
            </motion.div>
          </motion.div>
          ...
          <div className="flex justify-center lg:justify-start items-center lg:items-stretch shrink-0">
            <motion.div 
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1.2 }}
              viewport={{ once: true, margin: "-100px" }}
              transition={{ duration: 1, delay: 0.3, ease: "easeOut" }}
              className="w-full max-w-[500px] lg:max-w-none lg:w-auto lg:h-full aspect-square min-h-[400px] origin-center"
              style={{
